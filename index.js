...
const connecttomongo=require("./api/modules/db")
const express=require("express")
const app=express()
const path =require("path")
const port = process.env.PORT || 8000
const veri = require("./api/middleware/veri")
...
app.use("/registration",require("./api/routes/auth"))
app.use("/login",require("./api/routes/login"))
app.use("/contact",require("./api/routes/contact"))
